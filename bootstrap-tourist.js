    ...
    Tour = (function () {
        ...
        function Tour(options) {
            ...
            if (typeof (this._options.sanitizeFunction) == "function") {
                ...
                //
                // ** UPDATE: BS3 and BS4 and BS5 have the whitelist function. However:
                //		BS3 uses $.fn.popover.Constructor.DEFAULTS.whiteList
                //		BS4 uses $.fn.popover.Constructor.Default.whiteList
                //		BS5 uses bootstrap.Tooltip.DefaultAllowList
                //	Even better, the CDN version of BS4 doesn't seem to include a whitelist property at all,
                //	which utterly screwed the first attempt at implementing
                //  this, making it seem like my fix was working when in fact it was utterly broken.
                var defaultWhiteList = [];

                if (this._options.framework == "bootstrap5" && bootstrap.Tooltip.Default.allowList !== undefined) {
                    defaultWhiteList = bootstrap.Tooltip.Default.allowList;
                }
        ...
        Tour.prototype._showPopover = function (step, i) {
            ...
            if ($(document).find(".popover.tour-" + this._options.name + ".tour-" + this._options.name + "-" + this.getCurrentStepIndex()).length == 0) {
                ...
                var popOpts = {
                    ...
                    allowList: this._options.sanitizeWhitelist, // ignored if sanitizeFn is specified, BS5 addition
